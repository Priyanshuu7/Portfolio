...
const projects = [
  {
    ...
    technologies: ["React", "MongoDB", "Express", "Node", "Passport.js"],
    link: "#",
    github: "#"
  },
  {
    ...
    technologies: ["Javascript", "Express.js", "React.js", "Node.js", "MongoDB"],
    link: "#",
    github: "#"
  },
  {
      ...
      <div className="container max-w-5xl mx-auto px-4 sm:px-6">
        ...
        >
          {projects.map((project, index) => (
            ...
            >
              <Card className="h-full flex flex-col bg-background hover:shadow-lg transition-shadow">
                <CardHeader>
