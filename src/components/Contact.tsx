                    ...
                    <div className="space-y-8" style={{ opacity: 1, transform: "none" }}>
                        ...
                        <div className="space-y-4">
                            <a
                                ...
                                <div className="absolute bottom-0 left-0 w-full h-[2px] bg-primary" style={{ transform: "scaleX(0)" }}></div>
                                ...
                                <span className="text-muted-foreground group-hover:text-foreground transition-colors" style={{ transform: "none" }}>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        aria-hidden="true"
                                        role="img"
