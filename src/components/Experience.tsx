      ...
      <div className="container max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="space-y-10">
          <motion.div 
            ...
            custom={0}
          >
            <div className="absolute left-0 w-px h-full bg-border dark:bg-border/50 hidden md:block" />
            <Card className="md:ml-10 relative bg-background">
              <div className="absolute -left-3 top-1/2 transform -translate-y-1/2 w-6 h-6 rounded-full border-2 border-primary bg-background hidden md:block"></div>
              <CardHeader>
              ...
              <CardContent className="space-y-2">
                <ul className="list-disc pl-5 space-y-1.5 text-muted-foreground">
                  ...
                  <li>Designed efficient database schemas in Supabase, achieving query performance gains of 28%.</li>
                  <li>Led frontend architecture decisions and mentored interns on software development best practices and agile methodologies.</li>
                </ul>
              </CardContent>
            </Card>
          </motion.div>
            ...
            <Card className="bg-background">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  <strong>Relevant Coursework:</strong> Data Structures & Algorithms, Databases, Operating Systems, Software Engineering, Computer Networks.
                </p>
              </CardContent>
            </Card>
          </motion.div>
          ...
          >
            ...
            <Card className="bg-background">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Contributed to open-source course platform, improving frontend and backend code quality, documentation, and overall user experience.
                </p>
              </CardContent>
            </Card>
          </motion.div>
